...
TorchDiff/torchdiff/test_ddim.py::TestVarianceSchedulerDDIM::test_initialization_valid_params 
TorchDiff/torchdiff/test_ddim.py::TestVarianceSchedulerDDIM::test_initialization_invalid_params 
TorchDiff/torchdiff/test_ddim.py::TestVarianceSchedulerDDIM::test_beta_schedule_methods 
TorchDiff/torchdiff/test_ddim.py::TestVarianceSchedulerDDIM::test_trainable_beta 
TorchDiff/torchdiff/test_ddim.py::TestVarianceSchedulerDDIM::test_tau_schedule 
TorchDiff/torchdiff/test_ddim.py::TestForwardDDIM::test_forward_process 
TorchDiff/torchdiff/test_ddim.py::TestForwardDDIM::test_invalid_time_steps 
TorchDiff/torchdiff/test_ddim.py::TestReverseDDIM::test_reverse_process 
TorchDiff/torchdiff/test_ddim.py::TestReverseDDIM::test_stochastic_sampling 
TorchDiff/torchdiff/test_ddim.py::TestTrainDDIM::test_trainer_initialization 
TorchDiff/torchdiff/test_ddim.py::TestTrainDDIM::test_training_loop 
TorchDiff/torchdiff/test_ddim.py::TestTrainDDIM::test_checkpoint_save_load 
TorchDiff/torchdiff/test_ddim.py::TestSampleDDIM::test_sampler_initialization 
TorchDiff/torchdiff/test_ddim.py::TestSampleDDIM::test_unconditional_sampling 
TorchDiff/torchdiff/test_ddim.py::TestSampleDDIM::test_conditional_sampling 
TorchDiff/torchdiff/test_ddim.py::TestSampleDDIM::test_tokenization 
TorchDiff/torchdiff/test_ddim.py::TestIntegrationDDIM::test_end_to_end_pipeline 
TorchDiff/torchdiff/test_ddim.py::TestIntegrationDDIM::test_forward_reverse_consistency 

============================== 18 passed in 7.03s ==============================
PASSED [  5%]PASSED [ 11%]PASSED [ 16%]PASSED [ 22%]PASSED [ 27%]PASSED [ 33%]PASSED [ 38%]PASSED [ 44%]PASSED [ 50%]PASSED [ 55%]PASSED [ 61%]
Epoch: 1/2 | LR: 7.00e-05 | Train Loss: 1.5351


Epoch: 2/2 | LR: 1.40e-04 | Train Loss: 1.5335

100%|██████████| 7/7 [00:00<00:00, 266.39it/s]
100%|██████████| 7/7 [00:00<00:00, 306.42it/s]
PASSED [ 66%]Model saved at epoch 1
Loaded checkpoint from /tmp/tmp7o3qqyhi/ddim_epoch_1.pth at epoch 1 with loss 0.5000
PASSED [ 72%]PASSED [ 77%]PASSED [ 83%]PASSED [ 88%]PASSED [ 94%]
Epoch: 1/1 | LR: 5.00e-05 | Train Loss: 1.1194

100%|██████████| 5/5 [00:00<00:00, 151.04it/s]
PASSED [100%]
