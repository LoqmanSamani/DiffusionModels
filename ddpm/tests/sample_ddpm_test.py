...
from sample_ddpm import SampleDDPM




def test_sample_ddpm_unconditional():
...
def  test_sample_ddpm_conditional():
    device = torch.device("cuda")
...
if __name__ == "__main__":
    test_sample_ddpm_unconditional()
    test_sample_ddpm_conditional()